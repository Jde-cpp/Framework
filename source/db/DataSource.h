...
namespace Jde::DB
{
	...
	struct JDE_NATIVE_VISIBILITY IDataSource : std::enable_shared_from_this<IDataSource>
	{
		...
		[[noreturn]]virtual FunctionAwaitable SelectCo( sv /*sql*/, std::function<void(const IRow&)>* /*f*/, const std::vector<DataValue>* /*pParameters*/, bool /*log*/ )noexcept{ throw Exception("Not implemented"); }//return FunctionAwaitable{ []( coroutine_handle<Task2::promise_type> ){} }; }// 
