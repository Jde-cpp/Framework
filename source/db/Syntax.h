...
//		virtual ~Syntax()=default;
	...
	{
		string AddDefault( sv tableName, sv columnName, sv columnDefault )const noexcept{ return format("ALTER TABLE {} ALTER COLUMN {} SET DEFAULT {}", tableName, columnName, columnDefault); }
		...
		virtual bool HasUnsigned()const noexcept{ return true; }
		...
		sv ProcEnd()const noexcept{ return "end"sv; }
		sv ProcParameterPrefix()const noexcept{ return ""sv; }
		sv ProcStart()const noexcept{ return "begin"sv; }
