...
#######################################################
string(APPEND RELEASE " -O3 -march=native -Wno-range-loop-construct -Wno-empty-body -Wno-return-type-c-linkage -Wno-implicitly-unsigned-literal")
if(MSVC)
	string(APPEND DEBUG " /W4 /wd\"4068\" /wd\"4251\" /wd\"4275\" /wd\"4297\"")
	add_definitions( -DBOOST_ALL_DYN_LINK )
else()
	string(APPEND DEBUG " -O0 -g -D_GLIBCXX_DEBUG")
	string(APPEND DEBUG " -Wall -Wno-range-loop-construct -Wno-unknown-pragmas -Wno-empty-body -Wno-return-type-c-linkage -Wno-exceptions -Wno-#pragma-messages")
endif()
